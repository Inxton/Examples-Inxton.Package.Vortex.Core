...
](https://infosys.beckhoff.com/english.php?content=../content/1033/tc3_c/81064793403374091-1.html&id=)
## Set up HansPlcController project
...
~~~
## License file
License file is stored in  `SystemDisk:\Inxton\Licence.xml`.
In most cases it's `C:\Inxton\Licence.xml`

Get your license file from [Inxton](inxton.com) or use this [temporary licence](http://bit.ly/future_of_automation).

## Select the project you want to try

Set the project you would like to try as *StartUp project* and run the project.
...
We need to spend a word here about Inxton.Vortex.Compiler. It is one of the founding blocks of the Inxton.Vortex.Framework. It provides one to one C# objects from TwinCAT3 PLC program so you can use any .net based platform to access PLC data.

![inxton_transpile.gif](./assets/inxton_transpile.gif)

More about compiler [here](https://github.com/Inxton/documentation/blob/master/Inxton.vortex.compiler.console/README.md).
